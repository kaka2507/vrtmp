...
public class RtmpSessionInfo {
    ...
    private long markAbsoluteTimestamp = 0;

    public long getMarkAbsoluteTimestamp() {
        return markAbsoluteTimestamp;
    }

    public void setMarkAbsoluteTimestamp(long markAbsoluteTimestamp) {
        this.markAbsoluteTimestamp = markAbsoluteTimestamp;
    }
